...
async function fetchAndDisplayPrayerTimes(city = 'Karachi', country = 'Pakistan') {
    ...
    try {
        ...
        console.log('DOM elements:',
            document.getElementById('prayer-time-fajr'),
            document.getElementById('prayer-time-dhuhr'),
            document.getElementById('prayer-time-asr'),
            document.getElementById('prayer-time-maghrib'),
            document.getElementById('prayer-time-isha')
        );
        // Update UI
